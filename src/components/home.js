...
function Main() {
  return (
   <div style={{ backgroundColor: '#262626'}} className='w-full rounded-t-md flex flex-col justify-around align-center px-8 py-20 md:px-20 md:py-28 lg:align-center lg:flex-row lg:justify-between lg:px-30 lg:py-40'>
