...
const Skills = () => {
    return ( 
        <div style={{ backgroundColor: '#262626'}} className='text-white px-8 py-20 md:px-20 lg:px-30'>
        <h4 className='mb-4 text-3xl'>Industry relevant Skills</h4>
        <div>
        <h6 className='text-4xl'>Programming Languages</h6>
        <ul className='mb-4'>
            <li className='text-xl'>JavaScript</li>
            <li className='text-xl'>TypeScript</li>
            <li className='text-xl'>Java</li>
        </ul>
        <h6 className='text-4xl'>Frontend Development</h6>
        <ul className='mb-4'>
